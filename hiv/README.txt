...
Version: 0.1.0  
Release Date: 2025-05-19 Developer: Aldatu Biosciences, Inc.  
...
Installation
  ...
  * Download the signed Windows installer from the Aldatu website.
...
See the CHANGELOG for version details and release history.
...
Source code is available on GitHub under the MIT License. https://github.com/aldatubio/PANDAA-qPCR-Results/tree/main/hiv

Use of the compiled software is subject to the EULA included with the installer.
